...
@Library('github.com/devops-teamx/pipeline@helm-umbrella')

def pipeline = new io.ab.Pipeline()

podTemplate(label: 'jenkins-pipeline', containers: [
    containerTemplate(name: 'jnlp', image: 'jenkinsci/jnlp-slave:3.16-1-alpine', args: '${computer.jnlpmac} ${computer.name}', workingDir: '/home/jenkins', resourceRequestCpu: '200m', resourceLimitCpu: '300m', resourceRequestMemory: '1024Mi', resourceLimitMemory: '1024Mi'),
    containerTemplate(name: 'docker', image: 'docker:1.12.6', command: 'cat', ttyEnabled: true),
    containerTemplate(name: 'maven', image: 'jamesdbloom/docker-java8-maven', command: 'cat', ttyEnabled: true),
...
volumes:[
  ...
  node ('jenkins-pipeline') {
    ...
    def pwd = pwd()
    def chart_dir = "${pwd}/helm/transformers"
